    ...
    <tr>
        ...
        <td nowrap>
          <div class="btn-group" role="group" aria-label="..." style="width:60px;">
            <a class="btn btn-secondary btn-xs" href="<?php echo erLhcoreClassDesign::baseurl('lhcchatbot/edit')?>/<?php echo $item->id?>" ><i data-icon="edit" class="material-icons mr-0">edit</i></a>
            <a class="btn btn-danger btn-xs csfr-required" onclick="return confirm('<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('kernel/messages','Are you sure?');?>')" href="<?php echo erLhcoreClassDesign::baseurl('lhcchatbot/delete')?>/<?php echo $item->id?>" ><i data-icon="trash" class="material-icons mr-0">&#xE872;</i></a>
          </div>
        </td>
    </tr>
    <?php endforeach; ?>
...
<div><a class="btn btn-secondary" href="<?php echo erLhcoreClassDesign::baseurl('lhcchatbot/new')?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('lhcchatbot/module','New');?></a></div>